    ...
    <>
      <div className="w-[20%] h-full border-r-2 border-zinc-400 p-4">
        ...
        <nav className="flex flex-col text-zinc-400 text-xl ">
          ...
          <Link to="./movies" className="hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-4">
            <i className="mr-2 ri-movie-2-fill"></i>Movies
          </Link>
          <Link to="./tv" className="hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-4">
            <i className="mr-2 ri-tv-line"></i>Tv Shows
          </Link>
        ...
        <nav className="flex flex-col text-zinc-400 text-xl gap-3">
          ...
          <Link className="hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-4">
            <i className="mr-2 ri-information-fill"></i>About AMDB
          </Link>
          <Link className="hover:bg-[#6556CD] hover:text-white duration-300 rounded-lg p-4">
